...
class Blog(models.Model):
    ...
    added_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='blogs_added')
    updated_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='blogs_updated')
    ...
    def video_content_type(self):
        extension = os.path.splitext(self.video.name)[1].lower()
        return {
            '.mp4': 'video/mp4',
            '.webm': 'video/webm',
            '.ogg': 'video/ogg',
